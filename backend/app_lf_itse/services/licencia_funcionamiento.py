...
SELECT
    ...
    lf.tipo_letrero AS tipo_letrero_nombre,
...
def crear_licencia(data: dict, usuario) -> LicenciaFuncionamiento:
    ...
    with set_actor(usuario), transaction.atomic():
        licencia = LicenciaFuncionamiento.objects.create(
            ...
            zonificacion_id       = data.get('zonificacion_id'),
            area                  = data['area'],
...
def modificar_licencia(licencia_id: int, data: dict, usuario=None) -> LicenciaFuncionamiento:
    ...
    with set_actor(usuario), transaction.atomic():
        ...
        licencia.zonificacion_id        = data.get('zonificacion_id')
...
SELECT
    ...
    licencias_funcionamiento.tipo_letrero,
    licencias_funcionamiento.tipo_letrero AS tipo_letrero_nombre,
